...
public interface EntityManager {
	...
	<T> boolean delete(T obj) throws IllegalArgumentException,
	...
	<T> List<T> listAll(Class<T> cl) throws IllegalArgumentException,
			SecurityException, InstantiationException, IllegalAccessException,
			InvocationTargetException, NoSuchMethodException,
			NoSuchFieldException;

	<T> List<T> listAllMinimal(Class<T> cl) throws IllegalArgumentException,
			SecurityException, InstantiationException, IllegalAccessException,
			InvocationTargetException, NoSuchMethodException,
			NoSuchFieldException;
